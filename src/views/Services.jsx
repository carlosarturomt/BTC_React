...
function Services() {
	...
	return (
		<>
			<TemplateLogged>
				<section className="text-gray-200 py-4 md:px-28 lg:px-56">
					<h1 className="py-4 text-6xl font-semibold text-border-style text-center px-2 md:text-8xl ">
						Our Services
					</h1>
					<article className="flex justify-center glide relative">
						<aside className="glide__track" data-glide-el="track">
							<ul className="glide__slides flex justify-center items-center">
								<li className="glide__slide">
									<div className="customer-img text-center flex justify-center items-center">
										<img
						...
						<aside
							...
							className="flex justify-between absolute top-[40%] w-full md:w-[110%]"
						>
							<button
								data-glide-dir="<"
								className="flex items-center justify-center bg-[#ffffff17] p-2 rounded-full hover:bg-[#ffffff30]"
							>
								<svg
							...
							<button
								data-glide-dir=">"
								className="flex items-center justify-center bg-[#ffffff17] p-2 hover:bg-[#ffffff30] rounded-full"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="18"
