						...
						<article className="py-2">
							<aside className="py-2">
								...
								<div className="text-slate-300">
									...
									<p>
										Soy {candidateName}{" "}
										{age <= 10 ? "" : `, tengo ${Math.trunc(age)} años`}, es un
										placer postularme en la vacante de '{vacancyTitle}', será un
										placer ser parte del proceso de selección.
									</p>
									{/* <p>{ candidateEmail == '' ? ''
							...
							<aside className="py-2">
								...
								<p className="flex items-center">
									...
									<span className="text-slate-300 ml-1"> {candidateTel2}</span>
								</p>
								...
								<p className="flex items-center">
									...
									<span className="text-slate-300 ml-1"> {candidateGrade}</span>
								</p>
